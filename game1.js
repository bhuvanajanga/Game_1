...
window.onload = function() {
    $("#ol").html(`<center><div id="inst"><h2>Welcome to Matching Game!</h2><h4>Instructions For Game</h4><p>-------------------</P><h5>Make pairs of similiar blocks by flipping them.</h5><h5>To flip a block you can click on it.</h5><h5>If two blocks you clicked are not similar, they will be flipped back.</h5><p style="font-size:18px;">Click one of the following mode to start the game.</p></div><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button></center>`);
}
